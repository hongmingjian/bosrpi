...
## How to use?
- Download [kernel.img](https://github.com/hongmingjian/bosrpi/releases/download/v1.2/kernel.img) and copy it to the SD card. Or you can compile it from the source which is self-contained.
- Turnon your RPi.
...
- If you are using SecureCRT, you can customize the script **securecrt.py** to avoid time-consuming chores, such as clicking menu "Transfer->Send Xmodem", waiting for open-file-dialog to show up, navigating the file system to pick the file.
